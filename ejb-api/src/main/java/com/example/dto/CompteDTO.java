...
public class CompteDTO implements Serializable {
    ...
    public List<DebitDTO> getDebits() { return debits; }
    public void setDebits(List<DebitDTO> debits) { this.debits = debits; }

    public List<CreditDTO> getCredits() { return credits; }
    public void setCredits(List<CreditDTO> credits) { this.credits = credits; }
}
